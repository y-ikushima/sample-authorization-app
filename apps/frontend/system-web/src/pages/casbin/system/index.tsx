...
const CsbinSystemPage: NextPage = () => {
    ...
    const fetchSystems = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:3004/api/casbin/system/all"
        );
                ...
                {systems.map((system) => (
                  ...
                  >
                    ...
                    <div style={{ marginTop: "12px" }}>
                      <Link href={`/casbin/system/${system.ID}`}>
                        <button
                          style={{
                      ...
                      <a
                        href={`http://localhost:3000/casbin/system/${system.ID}`}
                        target="_blank"
...
export default CsbinSystemPage;
