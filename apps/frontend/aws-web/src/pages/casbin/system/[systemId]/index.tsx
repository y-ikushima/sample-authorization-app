...
export default function CasbinSystemAwsAccounts() {
  ...
  const {
    ...
    error: accessError,
  } = useSystemAccess(systemId as string, "GET", "casbin");
    ...
    const fetchAwsAccounts = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:3003/api/casbin/account/system/${systemId}`
        );
    ...
    <>
      ...
      <div>
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            <h1>システム {systemId} のAWSアカウント一覧 (Casbin)</h1>
          </div>
                  ...
                  >
                    ...
                    <div style={{ marginTop: "12px" }}>
                      <button
                        ...
                        onClick={() =>
                          router.push(
                            `/casbin/system/${systemId}/account/${account.ID}`
                          )
                        }
                      >
                        詳細を見る
